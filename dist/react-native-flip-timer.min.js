!(function (e, t) { typeof exports === 'object' && typeof module !== 'undefined' ? t(exports, require('react'), require('react-native'), require('prop-types'), require('react-native/Libraries/Utilities/MatrixMath')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-native', 'prop-types', 'react-native/Libraries/Utilities/MatrixMath'], t) : t((e = e || self)['flip-timer'] = {}, e.React, e.reactNative, e.PropTypes, e.MatrixMath); }(this, (e, t, r, n, i) => {
  function a(e, t, r) {
    ...
    let n = e.number; const i = e.unit; const a = e.size; const o = e.perspective; const s = e.numberWrapperStyle; const u = e.cardStyle; const p = e.flipCardStyle; const c = e.numberStyle; const m = e.direction; const f = void 0 === m ? 'up' : m; const d = e.noHoursLimit; n = parseInt(n); let b = f == 'down' ? n + 1 : n - 1; f == 'down' ? i !== 'hours' ? b = b === 61 ? 0 : b : d || (b = b === 24 ? 0 : b) : b = i !== 'hours' ? b === -1 ? 59 : b : b === -1 ? 23 : b, b = b < 10 ? `0${b}` : b; const y = (n = n < 10 ? `0${n}` : n).toString().split(''); const v = b.toString().split(''); return t.createElement(r.View, { style: l.wrapper }, t.createElement(h, {
      number: y[0], previousNumber: v[0], size: a, perspective: o, numberWrapperStyle: s, cardStyle: u, flipCardStyle: p, numberStyle: c,
    }), t.createElement(h, {
      number: y[1], previousNumber: v[1], size: a, perspective: o, numberWrapperStyle: s, cardStyle: u, flipCardStyle: p, numberStyle: c,
    }));
  ...
  }, e.Timer = w, e.FlipNumber = v, e.FlipCard = h, Object.defineProperty(e, '__esModule', { value: !0 });
}));
