(function (global, factory) {
  ...
  (function (_React$Component) {
    ...
    function NumberCard(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'transformRef', (ref, deg, y) => {
        ...
        const matrix = TransformUtils.createIdentityMatrix();
        TransformUtils.translateMatrix(matrix, {
          x: 0,
          y,
          z: 0,
        });
        TransformUtils.perspectiveMatrix(matrix, perspective);
        TransformUtils.rotateXMatrix(matrix, deg);
        TransformUtils.untranslateMatrix(matrix, {
          x: 0,
          y,
          z: 0,
        });
  ...
  (function (_React$Component) {
    ...
    _proto.componentDidMount = function componentDidMount() {
      ...
      const _TransformUtils$forma = TransformUtils.formatNumberToTime(time);
